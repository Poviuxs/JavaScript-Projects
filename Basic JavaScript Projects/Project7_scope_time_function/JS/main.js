...
function Add_numbers_1() {
    var x = 1000; // local variable
    document.write(1000 + x + "<br>"); // using local variable
}

function Add_numbers_2() {
    document.write(x + 15); // using global variable
...
function get_Date() {
 ...
 // if+else statment  function 
function get_Reply() {
    var user_input = document.getElementById("userInput").value; // Get user input
    var reply; 
    if (user_input % 2 === 0) {
